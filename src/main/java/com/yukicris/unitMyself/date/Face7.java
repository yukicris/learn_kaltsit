package com.yukicris.unitMyself.date;
   ...
   //优讯在线和智网伟业
    ...
    public static void getWeekend(String startDay,String endDay){
        ...
        try {
            ...
            System.out.println(""+(c1.get(c1.DAY_OF_WEEK)-1));
            //这个过时了,会有个-
            // sd.getDay();
            ...
            while(sd.compareTo(ed)<=0){
                c2.setTime(sd);
                System.out.println(""+(c2.get(c2.DAY_OF_WEEK)-1));
                if((c2.get(c2.DAY_OF_WEEK)-1)!=6 &&(c2.get(c2.DAY_OF_WEEK)-1)!=0 ){
                    result++;
                }
                sd.setDate(sd.getDate()+1);
            }
            System.out.println("工作日有"+result+"天");
